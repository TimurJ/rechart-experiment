...
function App() {
  ...
  useEffect(() => {
    fetch("https://sandbox.iexapis.com/stable/stock/aapl/intraday-prices/?token=Tpk_095b8e5990924d0c8c41c2209556da53&chartInterval=5")
      .then((response) => response.json())
      .then((data) => setLiveData(data))
  }, [])

  useEffect(() => {
    fetch("https://sandbox.iexapis.com/stable/stock/aapl/chart/date/20211020?token=Tpk_095b8e5990924d0c8c41c2209556da53&chartInterval=5")
      .then((response) => response.json())
